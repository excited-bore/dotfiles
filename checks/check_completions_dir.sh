...
if [ ! -f ~/.bash_completion ]; then
    if ! test -f aliases/.bash_aliases.d/.bash_completion; then
        wget -P ~/ https://raw.githubusercontent.com/excited-bore/dotfiles/main/aliases/.bash_aliases.d/.bash_completion
    else
        cp -fv aliases/.bash_aliases.d/.bash_completion ~/
    fi 
fi
...
if ! sudo test -f /root/.bash_completion; then
    ...
    if [ ! -f /root/.bash_completion ]; then
        if ! test -f aliases/.bash_aliases.d/.bash_completion; then
            sudo wget -P /root/ https://raw.githubusercontent.com/excited-bore/dotfiles/main/aliases/.bash_aliases.d/.bash_completion 
        else
            sudo cp -fv aliases/.bash_aliases.d/.bash_completion /root/
        fi 
    fi
