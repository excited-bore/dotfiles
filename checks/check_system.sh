...
if test -f /etc/alpine-release; then
    ...
    pac_ins_y="sudo apt -y install"
    pac_up="sudo apt upgrade"
    pac_up_y="sudo apt upgrade -y"
    pac_fullup="sudo apt full-upgrade"
    pac_fullup_y="sudo apt full-upgrade -y"
    ...
    pac_refresh_fullup="sudo apt update && sudo apt full-upgrade"
    pac_refresh_fullup_y="sudo apt update -y && sudo apt full-upgrade -y"
...
if hash nala &>/dev/null && [[ "$pac" == 'apt' ]]; then
    ...
    pac_up="sudo nala upgrade"
    pac_up_y="sudo nala upgrade -y"
    pac_fullup="sudo nala full-upgrade"
    pac_fullup_y="sudo nala full-upgrade -y"
    pac_refresh_up="sudo nala update && sudo nala upgrade"
    pac_refresh_up_y="sudo nala update && sudo nala upgrade -y"
    pac_refresh_fullup="sudo nala update && sudo nala full-upgrade"
    pac_refresh_fullup_y="sudo nala update && sudo nala full-upgrade -y"
