...
alias list-default-shell="grep '^'$USER: /etc/passwd | cut -d: -f7"
alias current-shell="grep '^'$USER: /etc/passwd | cut -d: -f7"

alias list-available-shells="cat /etc/shells | sed '/#/d; /^$/d'"
