...
# LESS
export LESS="  --CLEAR-SCREEN --RAW-CONTROL-CHARS --redraw-on-quit --LINE-NUMBERS --use-color --IGNORE-CASE --LONG-PROMPT --chop-long-lines --underline-special --mouse --QUIET --status-line --no-vbell --follow-name --exit-follow-on-close"
