...
" Ctrl - Y is -> Redo (universal) :
nnoremap <C-y> :redo<CR>
inoremap <C-y> <C-\><C-o>:redo<CR>
vnoremap <C-y> <Esc>:redo<CR>gv 
...
" Visual mode remaps
" Add gv if you prefer to stay in visual mode after doing this
vnoremap <space>   <Esc>`<i <Esc>`>la <Esc>
...
vnoremap <expr> #   (visualmode() == "\<C-v>" ? ':norm i#<cr>' : '<Esc>`<i#<Esc>`>la#<Esc>')
vnoremap <expr> //   (visualmode() == "\<C-v>" ? ':norm i//<cr>' : '<Esc>`<i/*<Esc>`>la*/<Esc>')
vnoremap <expr> --   (visualmode() == "\<C-v>" ? ':norm i--<cr>' : '<Esc>`<i--[[<Esc>`>la]]--<Esc>')
vnoremap <expr> "   (visualmode() == "\<C-v>" ? ':norm i"<cr>' : '<Esc>`<i"<Esc>`>la"<Esc>')
vnoremap <expr> '   (visualmode() == "\<C-v>" ? ":norm i'<cr>" : '<Esc>`<i''<Esc>`>la''<Esc>')
