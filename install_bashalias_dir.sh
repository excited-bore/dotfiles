...
cp -f checks/check_distro.sh ~/.bash_aliases.d/check_distro.sh
cp -f readline/rlwrap_scripts.sh ~/.bash_aliases.d/rlwrap_scripts.sh
...
sudo cp -f checks/check_distro.sh /root/.bash_aliases.d/check_distro.sh
sudo cp -f readline/rlwrap_scripts.sh /root/.bash_aliases.d/rlwrap_scripts.sh 
