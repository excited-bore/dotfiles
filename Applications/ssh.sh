...
function serber_mnt1(){
    ...
    if [ ! -e /mnt/mount2/.bashrc ]; then
        sshfs burpi@192.168.129.17:/media/ /mnt/mount2/ -o IdentityFile=/home/burp/.ssh/id_burpi,follow_symlinks,reconnect,default_permissions,uid=1000,gid=1001,workaround=rename;
    fi
}
